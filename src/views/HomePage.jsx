    ...
    return (
        ...
        <div className="hero-content text-center text-neutral-content">
          <div className="max-w-md">
            ...
            <p className="mb-5">This is a tool to simplify your worksheet calculations for defendants facing sentencing.
            You simply select the applicable options and the tool has the info to calculate the score or sentence length for you.</p>
