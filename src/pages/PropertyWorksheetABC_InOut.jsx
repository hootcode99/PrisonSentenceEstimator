...
const priorIncarcerationOptions = [{text: "None", value: 0}, {text: "less than 1 year", value: 3}, {text: "1 year or more", value: 6}];

const priorParoleViolationOptions = [{text: "None", value: 0}, {text: "1 or more", value: 2}];

export default function PropertyWorksheetABC_InOut() {
    ...
    const [PriorJuvenileMisdemeanorAdj, setPriorJuvenileMisdemeanorAdj] = useState(0);
    ...
    useEffect(() => {
        setSumTotal(
            ...
            Number(PriorJuvenileMisdemeanorAdj)
        );

    }, [mostSeriousConv, priorAdultFelonyConvs, priorAdultMisdemeanorConvs, priorIncarceration, 
        priorParoleViolation, PriorJuvenileFelonyAdj, PriorJuvenileMisdemeanorAdj]);
    ...
    return (
        ...
        <div className="flex flex-col w-full place-items-center">
            ...
            <div className="flex flex-col w-4/5">
                <RadioSectionDropdown title="Class A" options={classOptions.A} update_fn={setMostSeriousConv}/>
                <RadioSectionDropdown title="Class B" options={classOptions.B} update_fn={setMostSeriousConv}/>
                <RadioSectionDropdown title="Class C" options={classOptions.C} update_fn={setMostSeriousConv}/>
            </div>
            ...
            <div className="flex justify-center space-x-10 w-4/5">
                <RadioSection title="Select" options={misdemeanorOptions} update_fn={setPriorAdultMisdemeanorConvs}/>
            </div>
            ...
            <div className="flex justify-center space-x-10 w-4/5">
                <RadioSection title="Select" options={priorIncarcerationOptions} update_fn={setPriorIncarceration}/>
            </div>
            ...
            <div className="flex justify-center space-x-10 w-4/5">
                <RadioSection title="Select" options={priorParoleViolationOptions} update_fn={setPriorParoleViolation}/>
            </div>

            <div className="divider divider-accent"></div> 

            <SectionHeader title="Prior Juvenile Delinquency or YO Adjudications" score={PriorJuvenileFelonyAdj} subtext="" />
            <div className="flex justify-center space-x-10 w-4/5">
                <RadioSection title="Select" options={misdemeanorOptions} update_fn={setPriorJuvenileFelonyAdj}/>
            </div>
